...
;; STRUCTURE A : AlGaN/GaN MIS-HEMT, Al2O3-only gate dielectric (8 nm)
;;
...
(define t_diel   0.008)   ; Al2O3 gate dielectric (8 nm) -- STRUCTURE A
...
;;-------- 11. BUILD MESH & SAVE ----------------------------------;;
(sde:build-mesh "snmesh" "" "Structure_A_msh")
(sde:save-model "Structure_A")
